...
public class acRenderer implements Renderer {
	...
	// Objects
	private acView myOwner;                          // The BobView that this acRenderer belongs to.

	/**
	 * Sets the BobView associated with this acRenderer.
	 * 
	 * @param newOwner
	 *            - BobView associated with this renderer.
	 */
	public void setOwner(acView newOwner) {
		myOwner = newOwner;
	}
